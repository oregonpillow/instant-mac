...
brew install --cask anki sublime-text iterm2 transmission mark-text visual-studio-code firefox sabnzbd eloston-chromium && \
brew install docker wget zsh neofetch
