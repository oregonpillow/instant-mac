...
CASK_APPS="anki skype tunnelblick docker rectangle raycast bitwarden spotify sublime-text iterm2 hot monitorcontrol postman joplin transmission mark-text vscodium librewolf sabnzbd eloston-chromium"
# =====================
i=0
